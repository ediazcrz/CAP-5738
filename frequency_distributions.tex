...
get go. But a major disadvantage of a frequency table is that they are not always 
...
of each bar corresponds to the frequency whereas in a bar chart, it is the height. 
Figure \ref{histogram} is an example of a histogram created using a random age 
...
times the IQR. The biggest advantage of the box and whisker plot is its ability 
